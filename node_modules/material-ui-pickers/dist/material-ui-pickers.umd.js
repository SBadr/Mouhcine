(function (global, factory) {
...
}(this, (function (exports,React,PropTypes,require$$9) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  var require$$9__default = 'default' in require$$9 ? require$$9['default'] : require$$9;
  ...
  */
  ...
  var _reactDom2 = _interopRequireDefault(require$$9__default);
  ...
  var _reactDom = interopRequireDefault(require$$9__default);
  ...
  function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement(React.Fragment, null, React__default.createElement(DateTextField$1, _extends({
        ...
        labelFunc: labelFunc,
        clearable: clearable
      }, other)), React__default.createElement(ModalDialog$1, {
  ...
  var TransitionGroup = function (_React$Component) {
    ...
    function TransitionGroup(props, context) {
      ...
      _this._handleDoneAppearing = function (key, component) {
        ...
        var currentChildMapping = (0, ChildMapping$2.getChildMapping)(_this.props.children);
      ...
      _this.state = {
        children: (0, ChildMapping$2.getChildMapping)(props.children)
      };
      return _this;
    }
    ...
    TransitionGroup.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
      var nextChildMapping = (0, ChildMapping$2.getChildMapping)(nextProps.children);
      var prevChildMapping = this.state.children;

      this.setState({
        children: (0, ChildMapping$2.mergeChildMappings)(prevChildMapping, nextChildMapping)
      });
  ...
  unwrapExports(TransitionGroup_1$1);
  ...
  var PropTypes_1$1 = PropTypes$3.nameShape;
  var PropTypes_2$1 = PropTypes$3.transitionTimeout;
  ...
  var propTypes = {
    children: _propTypes2.default.node,
    name: PropTypes$3.nameShape.isRequired,
  ...
  var CSSTransitionGroupChild = function (_React$Component) {
    ...
    CSSTransitionGroupChild.prototype.transition = function transition(animationType, finishCallback, timeout) {
      var node = (0, require$$9__default.findDOMNode)(this);
  ...
  var _TransitionGroup2 = _interopRequireDefault(TransitionGroup_1$1);
  ...
  var propTypes = {
    transitionName: PropTypes$3.nameShape.isRequired,

    transitionAppear: _propTypes2.default.bool,
    transitionEnter: _propTypes2.default.bool,
    transitionLeave: _propTypes2.default.bool,
    transitionAppearTimeout: (0, PropTypes$3.transitionTimeout)('Appear'),
    transitionEnterTimeout: (0, PropTypes$3.transitionTimeout)('Enter'),
    transitionLeaveTimeout: (0, PropTypes$3.transitionTimeout)('Leave')
  };
  ...
  var SlideTransition = function SlideTransition(_ref) {
    var classes = _ref.classes,
        ...
        other = _objectWithoutPropertiesLoose(_ref, ["classes", "className", "children", "slideDirection"]);

    return React__default.createElement(reactAddonsCssTransitionGroup, _extends({
  ...
  function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      }, other), React__default.createElement("span", null, " ", children, " "));
    };
  ...
  function (_PureComponent) {
    ...
    function YearSelection() {
      ...
      _this.scrollToCurrentYear = function () {
        ...
        var currentYearElement = require$$9.findDOMNode(_this.selectedYearRef);
